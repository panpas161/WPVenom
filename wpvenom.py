...
parser.add_argument('-n',help="Name of the wordpress plugin")
parser.add_argument('-H',help="LHOST")
parser.add_argument('-P',help="LPORT")
parser.add_argument('-p',nargs='?',help="path of a payload to embed")
